...
namespace CDST.SignalR.Jobs
{
    ...
    /// 执行任务项目
    /// </summary>
    public class JobTaskItemDto : ExtensibleFullAuditedEntityDto<Guid>, IHasConcurrencyStamp
    {
        /// <summary>
        /// 并发标识
        /// </summary>
        ...
        /// 详细数据
        /// </summary>
        public List<JobTaskItemDetailDto> TaskItemDetails { get; set; } = new List<JobTaskItemDetailDto>();
